...
export default class Language {
    ...
    // List of BCP47 languages.
    static bcp47Languages = [
        { name: "Afar", code: "aa" },
        { name: "Abkhaz", code: "ab" },
    ...
    static getLanguageName(code) {
        const language = Language.bcp47Languages.find(language => language.code === code);
    ...
    static getLanguageCode(name) {
        const language = Language.bcp47Languages.find(language => language.name === name);
